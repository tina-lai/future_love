        ...
        <div id="content" class="clearfix">
            ...
            <div id="right-col">
                ...
                <div class="page-content">
                        ...
                        戀戀好康
                            <div class="breadcrumb">首頁 > 戀戀園地 > 戀戀好康</div>
                        </h2>
                    <div class="heading-dashline"></div>
                    <div class="top-selection clearfix">
                	<div class="selection-category">分類 ｜</div>
                    <ul class="clearfix" style="float: left; width: 550px;">
                    	<li><a href="join_01.php">食品類</a></li>
                        <li><a href="join_02.php">藝文類</a></li>
                        <li><a href="join_02.php">服務類</a></li>
                        <li><a href="join_01.php">食品類</a></li>
                        <li><a href="join_02.php">藝文類</a></li>
                        <li><a href="join_02.php">服務類</a></li>
                        <li><a href="join_01.php">食品類</a></li>
                ...
                <div class="dashline"></div>
                    ...
                    <div class="benefit">
                        <ul class="clearfix">
                            <li class="clearfix">
                                <a href="#"><img src="images/benefit.jpg" width="160" height="120" class="image"></a>
                                <div class="info">
                                  <div class="font-purple">御梅屋 – 月老媒</div>
                                  <div class="font-grey"> <span class="font-555">類別：</span>食品類</div>
