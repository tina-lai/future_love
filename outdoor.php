...
$query_active_rec = "SELECT * FROM love_admin_active where Love_Admin_ACopen='1' and Love_Admin_ACdatee >= '".date('Y/m/d')."' and Love_Admin_ACtype='2' order by Love_Admin_ACdate asc";
...
<!-- end 左欄內容-->
            ...
            <div id="right-col">
                ...
                <div class="top-selection clearfix">
                    ...
                    <ul class="clearfix">
                    	<li><a href="outdoor.php">近期</a></li>
                        <li><a href="outdoorN.php">北區</a></li>
                        <li><a href="outdoorM">中區</a></li>
                        <li><a href="outdoorS">南區</a></li>
                        <li><a href="outdoorH">歷史活動</a></li>
                  </ul>
                </div>
              ...
              ?>)
                                ...
                                <a href="group-info.php?<?php echo $MM_keepNone.(($MM_keepNone!="")?"&":"")."Love_Admin_ACid=".urlencode($row_active_rec['Love_Admin_ACid']) ?>" class="e-more">活動詳情</a>
                              </div>
                          </li>
