...
$query_active_rec = "SELECT * FROM love_admin_active where Love_Admin_ACopen='1' and Love_Admin_ACdatee >= '".date('Y/m/d')."' and Love_Admin_AClocal='ty' and (Love_Admin_ACtype='1' or Love_Admin_ACtype='3' or Love_Admin_ACtype='4') order by Love_Admin_ACdate asc";
