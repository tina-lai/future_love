                ...
                <div class="about_square">
                    ...
                    <div style="width:100%;height:200px;">
                       <div style="float:left;width:35%;">
                          <img src="images/team_1.jpg" border="0">
                       </div>
                       <div style="float:left;width:65%;">
                          ...
                          人數：55~72<br>
                          交友建議：專注、 投入、 風度<br>
                          外型斯文的台北場主持人、總在一開場即以幽默詼諧的方式，為來賓的緊張情緒破冰…設計團體遊戲一把罩，期望令參加會員能以較輕鬆自在的態度認識，專攻室內中、大型式的聯誼活動。<br>
                       </div>
                    </div>
                     <div class="dashline"></div>
                    <div style="width:100%;height:200px;">
                       <div style="float:left;width:35%;">
                          <img src="images/team_2.jpg" border="0">
                       </div>
                       <div style="float:left;width:65%;">
                         <h3>桃園團隊</h3><br>
                          主持人：杏仁<br>
                          ...
                          人數：42~52 <br>
                          交友建議：可以積極，但不能太心急<br>
                          杏仁妹可說是戀戀未來團隊中極少數的女主持人歐，七年級後段班的她，主持氣氛靡漫著無與倫比的青春活力，現場總是熱血不已，相當受到桃竹苗地區年輕朋友們喜愛。<br>
                       </div>
                    </div>
                     <div class="dashline"></div>
                    <div style="width:100%;height:200px;">
                       <div style="float:left;width:35%;">
                          <img src="images/team_3.jpg" border="0">
                       </div>
                       <div style="float:left;width:65%;">
                          <h3>高雄團隊</h3><br>
                          主持人：小煒<br>
                    ...
                    <div style="width:100%;height:200px;">
                       <div style="float:left;width:35%;">
                          <img src="images/team_4.jpg" border="0">
                       </div>
                       <div style="float:left;width:65%;">
                        <h3>台南團隊</h3><br>
                         主持人：Eason<br>
                         ...
                         人數：38~50<br>
                         交友建議：平衡最美<br>
                         文質彬彬擅長兼具寓教於樂的主持風格，引進NLP理論，快速幫助來賓能更認識自已，並清楚交友目標，學習良好的表達技巧，現正努力深耕中南部市場的Eason其用心之下，現在擁有許多"E粉團"的會員好友喲！<br>
                       </div>
                    </div>
                    <!--
