...
$query_active_rec = "SELECT * FROM love_admin_active where Love_Admin_ACopen='1' and Love_Admin_Acbussiness='2' order by Love_Admin_ACdatee desc";
...
<!-- end 左欄內容-->
            ...
            <div id="right-col">
                ...
                <!--<div class="top-selection clearfix">
                    ...
                    <ul class="clearfix">
                    	<li><a href="group.php">近期</a></li>
                        <li><a href="taipei.php">台北</a></li>
                        <li><a href="taoyuan">桃園</a></li>
                        <li><a href="hsinchu">新竹</a></li>
                        <li><a href="taichung">台中</a></li>
                        <li><a href="tainan">台南</a></li>
                        <li><a href="kaohsiung">高雄</a></li>
