...
$query_active_rec = "SELECT * FROM love_admin_active where Love_Admin_ACopen='1' and Love_Admin_ACdatee >= '".date('Y/m/d')."' and Love_Admin_ACtype='2' and (Love_Admin_AClocal='tp' or Love_Admin_AClocal='ty' or Love_Admin_AClocal='hc' or Love_Admin_AClocal='yl') order by Love_Admin_ACdate asc";
