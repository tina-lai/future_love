...
$query_active_rec = "SELECT * FROM love_admin_active where Love_Admin_ACopen='1' and Love_Admin_ACdatee >= '".date('Y/m/d')."' and Love_Admin_ACtype='2' and (Love_Admin_AClocal='jy' or Love_Admin_AClocal='tn' or Love_Admin_AClocal='kh' or Love_Admin_AClocal='pt') order by Love_Admin_ACdate asc";
